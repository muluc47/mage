    ...
    <div class="product-details">
        ...
        <div class="social-share-icons">
            <ul class="list-inline social-links">
                ...
                <li>
                    <a href="https://twitter.com/home?status={{ $product->name }} {{ url()->current() }}" target="_blank">
                        <i class="fa fa-twitter" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ url()->current() }}&summary={{ $product->name }}&source={{ url()->current() }}" target="_blank">
                        <i class="fa fa-linkedin" aria-hidden="true"></i>
                    </a>
                </li>
                <li>
                    <a href="https://pinterest.com/pin/create/button/?url={{ url()->current() }}&media={{ $product->base_image->path }}&description={{ $product->name }}" target="_blank">
