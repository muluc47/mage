...
namespace Baslat\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use Baslat\Scaffold\Module\Generators\FilesGenerator;
use Baslat\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \Baslat\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \Baslat\Scaffold\Module\Generators\FilesGenerator
     */
    ...
    protected $files = [
        ...
        'providers/route-service-provider.stub' => 'Providers/RouteServiceProvider.php',
    ];
     ...
     * @param \Baslat\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \Baslat\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
    ...
    {
        $this->finder->makeDirectory($this->getModulesPath('Routes'));
    ...
    private function removeUnneededFiles()
    {
        ...
        $this->finder->deleteDirectory($this->getModulesPath('Repositories'));
...
JSON;
        ...
        $replace = <<<JSON
"description": "The Baslat {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The Baslat {$moduleName} Module.\"," . PHP_EOL;
