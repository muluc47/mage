...
$(function () {
    ...
    var o = $.Baslat.options;

    // Set up the object
    _init();

    // Activate layout
    $.Baslat.layout.activate();
    ...
    if (o.sidebarPushMenu) {
        $.Baslat.pushMenu.activate(o.sidebarToggleSelector);
    }
...
function _init() {
    ...
    $.Baslat.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.Baslat.options.screenSizes;
    ...
    // Tree
    $.Baslat.tree = function (menu) {
        var animationSpeed = $.Baslat.options.animationSpeed;
