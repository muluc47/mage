...
Baslat.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (Baslat.dataTable.selected[selector] === undefined) {
            Baslat.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! Baslat.dataTable.selected[this.selector].includes(id)) {
            Baslat.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        Baslat.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = Baslat.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return Baslat.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        Baslat.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        Baslat.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return Baslat.dataTable.selected[selector];
    }
