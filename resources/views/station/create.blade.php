                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="city-column" class="form-control" placeholder="İstasyon Adı" name="name">
                        <label for="city-column">İstasyon Adı</label>
                      </div>
                      <div class="form-label-group">
                        <input type="text" id="mapaddress" class="form-control" name="address" placeholder="Adres">
