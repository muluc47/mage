      ...
      <div class="col-xl-12 col-md-12 col-12 dashboard-greetings">
        <div class="card">
          <div class="card-header">
            <h3 class="greeting-text">Buraya İstatistikler Aşağıdakilere benzer şekilde gelecek</h3>
            <p class="mb-0">Sonradan hangi verilerin çekileceği kararlaştırılacak</p>
          </div>
