                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="city-column" class="form-control" placeholder="Bayi Adı" name="title">
                        <label for="city-column">Bayi Adı</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="phone" placeholder="Bayi Telefon">
                        <label for="">Bayi Telefon</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="fax" placeholder="Bayi Fax">
                        <label for="">Bayi Fax</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="email" placeholder="Bayi Email">
                        <label for="">Bayi Email</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="kep" placeholder="Kep Adres">
                        <label for="">Kep Adres</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="owner" placeholder="Yetkili Kişi">
                        <label for="">Yetkili Kişi</label>
                      </div>
                    </div>
                    <div class="col-md-6 col-12">
                      <div class="form-label-group">
                        <input type="text" id="" class="form-control" name="owner_phone" placeholder="Yetkili Telefon">
